...
#define LOCAL_PATH [NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, YES).firstObject stringByAppendingPathComponent:@"localPath.plist"]
...
- (void)getContentHtml
{
    self.htmlDict = [NSDictionary dictionaryWithContentsOfFile:LOCAL_PATH];
    if (self.htmlDict) {
        self.navigationItem.title= self.htmlDict[@"title"];
    ...
    NSURLRequest *requst = [NSURLRequest requestWithURL:[NSURL URLWithString:@"http://c.m.163.com/nc/article/C1EIHLG905298O5P/full.html"]];
        ...
        if (error == nil) {
            ...
            BOOL success = [self.htmlDict writeToFile:LOCAL_PATH atomically:YES];
...
//
//    //image的路径
//    NSURL *imagePath = [[NSBundle mainBundle] URLForResource:@"aaa" withExtension:@"png"];
    
    
    NSString *cssPath = [[NSBundle mainBundle] pathForResource:@"newDetail" ofType:@"css"];
    
    NSString *jsPath = [[NSBundle mainBundle] pathForResource:@"newDetail" ofType:@"js"];
    
    NSString *imagePath = [[NSBundle mainBundle] pathForResource:@"aaa" ofType:@"png"];
    
    
    NSFileManager *manager = [NSFileManager defaultManager];
//    NSString *cssFilePath = [NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, YES).firstObject stringByAppendingPathComponent:@"newDetail.css"];
//    NSString *jsFilePath = [NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, YES).firstObject stringByAppendingPathComponent:@"newDetail.js"];
//    NSString *imageFilePath = [NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, YES).firstObject stringByAppendingPathComponent:@"aaa.png"];
    
//    NSString *cssFilePath = [NSSearchPathForDirectoriesInDomains(NSCachesDirectory, NSUserDomainMask, YES).firstObject stringByAppendingPathComponent:@"newDetail.css"];
//    NSString *jsFilePath = [NSSearchPathForDirectoriesInDomains(NSCachesDirectory, NSUserDomainMask, YES).firstObject stringByAppendingPathComponent:@"newDetail.js"];
//    NSString *imageFilePath = [NSSearchPathForDirectoriesInDomains(NSCachesDirectory, NSUserDomainMask, YES).firstObject stringByAppendingPathComponent:@"aaa.png"];
    
    NSString *cssFilePath = [NSTemporaryDirectory() stringByAppendingPathComponent:@"newDetail.css"];
    NSString *jsFilePath = [NSTemporaryDirectory() stringByAppendingPathComponent:@"newDetail.js"];
    NSString *imageFilePath = [NSTemporaryDirectory() stringByAppendingPathComponent:@"aaa.png"];
    
    BOOL success1 = [manager copyItemAtPath:cssPath toPath:cssFilePath error:nil];
    BOOL success2 = [manager copyItemAtPath:jsPath toPath:jsFilePath error:nil];
    BOOL success3 = [manager copyItemAtPath:imagePath toPath:imageFilePath error:nil];
    NSLog(@"%d,%d,%d",success1,success2,success3);
...
//                      ,cssPath,jsPath,title,sourceName,sourceTime,body];
    ...
    NSString *html = [NSString stringWithFormat:@"\
                      ...
                      ,cssFilePath,jsFilePath,title,sourceName,sourceTime,body];
...
//    NSArray *fileLis2 = [manager contentsOfDirectoryAtURL:[NSURL fileURLWithPath:[[NSBundle mainBundle] resourcePath]] includingPropertiesForKeys:nil options:0 error:nil];
//
...
//    NSString *document =  NSSearchPathForDirectoriesInDomains(NSCachesDirectory, NSUserDomainMask, YES).firstObject;
    ...
    //NSArray *fileList = [manager contentsOfDirectoryAtPath:document error:nil];
    
    NSURL *baseURL = [NSURL fileURLWithPath:document];
//    NSURL *baseURL = [NSURL fileURLWithPath:NSHomeDirectory()];
    NSArray *fileLis2 = [manager contentsOfDirectoryAtURL:baseURL includingPropertiesForKeys:nil options:0 error:nil];
